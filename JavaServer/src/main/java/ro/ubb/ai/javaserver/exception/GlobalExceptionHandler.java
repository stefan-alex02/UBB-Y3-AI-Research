...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(SecurityException.class) // For custom security/authz checks
    ...
    public ResponseEntity<?> handleGlobalException(Exception ex, WebRequest request) {
        ...
        log.error("Global exception handler caught: ", ex); // Log with stack trace
        return new ResponseEntity<>(errorDetails, HttpStatus.INTERNAL_SERVER_ERROR);
    }

    // Simple ErrorDetails DTO
    private static class ErrorDetails {
        private Date timestamp;
        private String message;
        private String details;
        private Map<String, String> validationErrors; // Optional field for validation
